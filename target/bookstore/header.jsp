...
<div class="header_top">
    ...
    <div class="header_top_left">您好！欢迎<%=user.getUsername()%>登录当当网 [<a href="#" onclick="logout()" target="_parent">注销</a>]</div>
    <%}else {%>
    <div class="header_top_left">您好！欢迎<%=user.getUsername()%>登录当当网 [<a href="#" onclick="logout()" target="_parent">注销</a>][<a href="rootpage/rootindex.html" target="_parent">进入后台</a>]</div>
    <%}%>
