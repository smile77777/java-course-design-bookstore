...
<div id="header">
    <div id="register_header">
        ...
        <div class="register_header_right"><a href="index.jsp" class="blue">首页</a> | <a href="product.jsp" class="blue">商品展示页</a>  | <a href="shopping.html" class="blue">购物车</a> |  <a href="login.jsp" class="blue">登录</a></div>
    </div>
</div>
<div id="main">
    <div class="register_content">
        ...
        <div class="register_message">
            <form action="userservlet" method="post" id="myform">
                ...
                <dl class="register_row">
                    <dt>设置昵称：</dt>
                    <dd><input id="nickName" name="nickName" type="text" class="register_input"/></dd>
                    <dd><div id="nickName_prompt"></div></dd>
                </dl>
                <dl class="register_row">
                    <dt>设定密码：</dt>
                    <dd><input id="pwd" name="pwd" type="password" class="register_input"/></dd>
                ...
                <dl class="register_row">
                    <dt>性别：</dt>
                    <dd><input name="sex" name="sex" id="man" type="radio" value="男" checked="checked"/> <label for="man">男</label></dd>
                    <dd> <input name="sex" name="sex" id="woman" type="radio" value="女"/> <label for="woman">女</label></dd>
                </dl>
                <dl class="register_row">
                    <dt>所在地区：</dt>
                    <dd>
